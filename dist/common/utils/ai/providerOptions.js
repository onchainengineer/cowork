...
openaiTruncationMode) {
    ...
    const effectiveThinking = (0, policy_1.enforceThinkingPolicy)(modelString, thinkingLevel);
    ...
    if (provider === "anthropic") {
        ...
        if (isOpus45) {
            ...
            const effortLevel = thinking_1.ANTHROPIC_EFFORT[effectiveThinking];
            const budgetTokens = thinking_1.ANTHROPIC_THINKING_BUDGETS[effectiveThinking];
            log_1.log.debug("buildProviderOptions: Anthropic Opus 4.5 config", {
                effort: effortLevel,
                budgetTokens,
            ...
            log_1.log.debug("buildProviderOptions: Returning Anthropic Opus 4.5 options", options);
            return options;
        }

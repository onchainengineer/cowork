 ...
 * On Windows, unix requires Git for Windows' Git Bash (WSL is not supported).
 */
...
function getBashPathForPlatform(params) {
    ...
    if (!bashPath) {
        throw new Error("Git Bash not found. On Windows, unix requires Git for Windows (Git Bash). WSL is not supported. Install Git for Windows from https://git-scm.com/download/win");
    }
    return bashPath;
}
/**

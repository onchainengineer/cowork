...
exports.formatBashOutputReport = formatBashOutputReport;
exports.tryParseBashOutputReport = tryParseBashOutputReport;
const assert_1 = __importDefault(require("../../../common/utils/assert"));
function getMarkdownCodeFenceDelimiter(args) {
    (0, assert_1.default)(typeof args.output === "string", "output must be a string");
...
function formatBashOutputReport(args) {
    (0, assert_1.default)(typeof args.processId === "string" && args.processId.length > 0, "processId required");
    (0, assert_1.default)(typeof args.status === "string" && args.status.length > 0, "status required");
    (0, assert_1.default)(typeof args.output === "string", "output must be a string");
    const lines = [];
...
function tryParseBashOutputReport(reportMarkdown) {
